$(function () {
    ...
    var detailed_init = function () {
        var detail_string = "<div id=\"output-content\"><div id=\"output-contents\"><div id=\"actor-id-info\"><div id=\"exe-id\" class=\"col-md-6\"></div><div id=\"next-id\" class=\"col-md-6\"></div></div><div class=\"panel panel-default\" id=\"actor-display\"><div id=\"display-heading\" class=\"panel-heading\">Program state will appear here once evaluation begins.</div><div class=\"panel-body\"><div id=\"actor-info-id\" class=\"col-md-4\"></div><div id=\"actor-info-beh\" class=\"col-md-4\"></div><div id=\"actor-info-cr\" class=\"col-md-4\"></div><div id=\"actor-info-table\" class=\"row\"><div id=\"actor-inbox-table\" class=\"col-md-6\"></div><div id=\"actor-bindings-table\" class=\"col-md-6\"></div></div></div></div><div class=\"checkbox\"><label><input id=\"editor-check\" type=\"checkbox\">Enable message editing (can cause unexpected behaviour)</label></div></div></div>";
    ...
    var is_valid = function (type, input) {
        ...
        if (type === "UnitV") {
            ...
            matched_string = input.match(valid_string_re);
            if (matched_string) {
                return true;
            } else {
                return false;
            ...
            matched_string = input.match(/[0-9]+/);
            if (matched_string) {
                return true;
            } else {
                return false;
            ...
            for (var i = 0; i < inbox.length; i++) {
                ...
                for (var j = inbox[i].length - 1; j >= 0; j--) {
                    ...
                    if (inbox[i][j].tag === "ListV") {
                        ...
                        inbox_table = inbox_table + "Encrypted with \"" + inbox[i][j].contents[1] + "\"";
                    } else {
